...
export TF_VAR_route53_zone_name="$ENV_DNS.$FUNC_SCOPE_SHORT.eu.$ORG_SCOPE.odp.cloud.vwgroup.com."
export TF_VAR_route53_internal_name="$MODULE_NAME.$ENV_DNS.$FUNC_SCOPE_SHORT.eu.$ORG_SCOPE.odp.cloud.vwgroup.com"
export TF_VAR_gsb_clb_sg="sg.$ORG_SCOPE.$FUNC_SCOPE.$MODULE_NAME.$ENVIRONMENT.clb"
